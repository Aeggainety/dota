...
@section('transfer')
    ...
    <form method='POST' action='store'>
    	微信：<input type='text' id='wechat' name='wechat' placeholder='请输入微信号'><br><br>
    	游戏ID：<input type='text' id='DOTAID' name='DOTAID' placeholder='请输入DOTA2ID'><br><br>
    	游戏昵称：<input type='text' id='DOTAName' name='DOTAName' placeholder='请输入DOTA昵称'><br><br>
    	天梯分：<input type='text' id='LadderTournament' name='LadderTournament' placeholder='请输入天梯单排分'><br><br>
    	角色：	<select name='role'>
